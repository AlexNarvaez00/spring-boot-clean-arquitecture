...
public class DepartamentalCoordinatorUpdate {
    public static DepartamentalCoordinator run(
        DepartamentalCoordinatorRepository repo,
        UUID id,
        DepartamentalCoordinator arg
    ) {
        arg.setId(id);
