package mx.edu.itoaxaca.api.v1.support_areas.infrastructure.controllers;

import jakarta.validation.Valid;
import java.util.UUID;
import lombok.RequiredArgsConstructor;
import mx.edu.itoaxaca.Routes;
import mx.edu.itoaxaca.api.v1.support_areas.application.SupportAreaCreate;
import mx.edu.itoaxaca.api.v1.support_areas.application.SupportAreaDestroy;
import mx.edu.itoaxaca.api.v1.support_areas.application.SupportAreaGetAll;
import mx.edu.itoaxaca.api.v1.support_areas.application.SupportAreaGetById;
import mx.edu.itoaxaca.api.v1.support_areas.application.SupportAreaUpdate;
...
import mx.edu.itoaxaca.api.v1.support_areas.domain.SupportAreaStoreRequest;
import mx.edu.itoaxaca.api.v1.support_areas.domain.SupportAreaUpdateRequest;
